...
public class Invoice {
    ...
    public String generateInvoiceText() {
        ...
        System.out.println("================================");
        sb.append(String.format("= INVOICE NUMBER: %s", invoiceNumber)).append("\n");
        sb.append(String.format("= STATUS: %s", status)).append("\n");
        sb.append(order.getItemsList());
        sb.append(String.format("= SUM: %.2f EUR", priceWithoutVAT)).append("\n");
        sb.append(String.format("= VAT (21%%): %.2f EUR", priceWithVAT - priceWithoutVAT)).append("\n");
        sb.append(String.format("= TOTAL: %.2f EUR", priceWithVAT)).append("\n");
        return sb.toString();
    }
}
